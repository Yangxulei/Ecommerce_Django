...
from ec_order.models import OrderInfo,OrderDetailInfo
from ec_user.islogin import islogin
from ec_cart.models import CartInfo
from ec_goods.models import GoodsInfo
from ec_user.models import UserInfo
...
def order(request):
    ...
    return render(request, 'ec_order/place_order.html', context)
...
def pay(request,oid):
    ...
    order.save()
    context={'order':order}
    return render(request,'ec_order/pay.html',context)